...
class ListsApi
{
    ...
    public function getContactsFromListWithHttpInfo($list_id, $modified_since = null, $limit = null, $offset = null)
    {
        ...
        if (!is_null($limit) && ($limit > 500.0)) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ListsApi.getContactsFromList, must be smaller than or equal to 500.0.');
        }
    ...
    public function getFolderListsWithHttpInfo($folder_id, $limit = null, $offset = null)
    {
        ...
        if (!is_null($limit) && ($limit > 50.0)) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ListsApi.getFolderLists, must be smaller than or equal to 50.0.');
        }
    ...
    {
        if (!is_null($limit) && ($limit > 50.0)) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ListsApi.getLists, must be smaller than or equal to 50.0.');
        }
