...
class CreateAttribute implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'value' => 'string',
        'enumeration' => '\Swagger\Client\Model\CreateAttributeEnumeration[]',
        'type' => 'string'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("text", "date", "float", "boolean", "id", "category");
    ...
    /**
     * Gets enumeration
     * @return \Swagger\Client\Model\CreateAttributeEnumeration[]
     */
    ...
    /**
     * Sets enumeration
     * @param \Swagger\Client\Model\CreateAttributeEnumeration[] $enumeration List of values and labels that the attribute can take. Use only if the attribute's category is \"category\". For example, [{'value':1, 'label':'male'}, {'value':2, 'label':'female'}]
     * @return $this
     */
    ...
    public function setType($type)
    {
        ...
        if (!in_array($type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'text', 'date', 'float', 'boolean', 'id', 'category'");
        }
