...
class CreateSenderIps implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['weight']) && ($this->container['weight'] > 100.0)) {
            $invalid_properties[] = "invalid value for 'weight', must be smaller than or equal to 100.0.";
        }

        if (!is_null($this->container['weight']) && ($this->container['weight'] < 1.0)) {
            $invalid_properties[] = "invalid value for 'weight', must be bigger than or equal to 1.0.";
        }
    ...
    public function valid()
    {
        ...
        if ($this->container['weight'] > 100.0) {
            return false;
        }
    ...
    public function setWeight($weight)
    {
        ...
        if ($weight > 100.0) {
            throw new \InvalidArgumentException('invalid value for $weight when calling CreateSenderIps., must be smaller than or equal to 100.0.');
        }
        if ($weight < 1.0) {
            throw new \InvalidArgumentException('invalid value for $weight when calling CreateSenderIps., must be bigger than or equal to 1.0.');
        }
