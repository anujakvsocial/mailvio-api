...
class EmailExportRecipients implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("all", "nonClickers", "nonOpeners", "clickers", "openers", "softBounces", "hardBounces", "unsubscribed");
        if (!in_array($this->container['recipients_type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'recipients_type', must be one of #{allowed_values}.";
        }
    ...
    public function setRecipientsType($recipients_type)
    {
        ...
        if (!in_array($recipients_type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'recipients_type', must be one of 'all', 'nonClickers', 'nonOpeners', 'clickers', 'openers', 'softBounces', 'hardBounces', 'unsubscribed'");
        }
