...
class GetProcess implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("queued", "in_process", "completed");
    ...
    public function setStatus($status)
    {
        ...
        if (!in_array($status, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'status', must be one of 'queued', 'in_process', 'completed'");
        }
