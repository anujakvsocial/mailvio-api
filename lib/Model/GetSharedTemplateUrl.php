 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetSharedTemplateUrl implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shared_url'] === null) {
            $invalid_properties[] = "'shared_url' can't be null";
        }
    ...
    /**
     * Sets shared_url
     * @param string $shared_url A unique URL for the email campaign or transactional template. This URL can be shared with other Mailvio users.
     * @return $this
     */
