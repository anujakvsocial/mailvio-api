...
class GetSmsEventReportEvents implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("bounces", "hardBounces", "softBounces", "delivered", "sent", "accepted", "unsubscription", "replies", "blocked");
    ...
    public function setEvent($event)
    {
        ...
        if (!in_array($event, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'event', must be one of 'bounces', 'hardBounces', 'softBounces', 'delivered', 'sent', 'accepted', 'unsubscription', 'replies', 'blocked'");
        }
