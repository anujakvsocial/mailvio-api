...
class RequestSmsRecipientExport implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("all", "delivered", "answered", "softBounces", "hardBounces", "unsubscribed");
    ...
    public function setRecipientsType($recipients_type)
    {
        ...
        if (!in_array($recipients_type, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'recipients_type', must be one of 'all', 'delivered', 'answered', 'softBounces', 'hardBounces', 'unsubscribed'");
        }
