...
class SendEmail implements ArrayAccess
{
    ...
    /**
     * Sets attachment
     * @param \Swagger\Client\Model\SendEmailAttachment[] $attachment Pass the list of content (base64 encoded) and name of the attachment. For example, [{'content':'base64 encoded content 1', 'name':'attcahment1'}, {'content':'base64 encoded content 2', 'name':'attcahment2'}].
     * @return $this
     */
