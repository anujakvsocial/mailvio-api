...
class SendTestSms implements ArrayAccess
{
    ...
    /**
     * Sets phone_number
     * @param string $phone_number Mobile number of the recipient with the country code. This number must belong to one of your contacts in Mailvio account and must not be blacklisted
     * @return $this
     */
