...
class UpdateAttribute implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'value' => 'string',
        'enumeration' => '\Swagger\Client\Model\UpdateAttributeEnumeration[]'
    );
    ...
    /**
     * Gets enumeration
     * @return \Swagger\Client\Model\UpdateAttributeEnumeration[]
     */
    ...
    /**
     * Sets enumeration
     * @param \Swagger\Client\Model\UpdateAttributeEnumeration[] $enumeration List of the values and labels that the attribute can take. Use only if the attribute's category is \"category\". For example, [{'value':1, 'label':'male'}, {'value':2, 'label':'female'}]
     * @return $this
     */
