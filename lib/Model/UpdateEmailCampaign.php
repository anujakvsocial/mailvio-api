...
class UpdateEmailCampaign implements ArrayAccess
{
    ...
    public function setSplitRule($split_rule)
    {
        ...
        if ($split_rule > 50.0) {
            throw new \InvalidArgumentException('invalid value for $split_rule when calling UpdateEmailCampaign., must be smaller than or equal to 50.0.');
        }
        if ($split_rule < 1.0) {
            throw new \InvalidArgumentException('invalid value for $split_rule when calling UpdateEmailCampaign., must be bigger than or equal to 1.0.');
        }
    ...
    public function setWinnerDelay($winner_delay)
    {
        ...
        if ($winner_delay > 168.0) {
            throw new \InvalidArgumentException('invalid value for $winner_delay when calling UpdateEmailCampaign., must be smaller than or equal to 168.0.');
        }
        if ($winner_delay < 1.0) {
            throw new \InvalidArgumentException('invalid value for $winner_delay when calling UpdateEmailCampaign., must be bigger than or equal to 1.0.');
        }
